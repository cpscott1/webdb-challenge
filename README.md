...
RDBMS is a the database software while SQL is the language used to interact with the software.

1. Why do tables need a `primary key`?

To uniquely indentify table records
1. What is the name given to a table column that references the primary key on another table.

Foreign key
1. What do we need in order to have a _many to many_ relationship between two tables.
You need 3 tables with the 3rd joining the two tables together using a foreign key. 
## Project Set Up
